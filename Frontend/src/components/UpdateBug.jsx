            ...
            >
              ...
              <div className="form-input">
                ...
                <input
                  type="text"
                  name="bugName"
                  value={data.bugName || bugToUpdate.bugName}
                  onChange={handleUpdateFormChange}
                />
              </div>
              <div className="form-input">
      ...
      {bugToUpdate.length > 0 ? ( // Check if deletedBug has data
        <div>
          {bugToUpdate.map((data) => (
            <div key={data.id}>
              <h1 style={{ color: "red" }}>
                Bug Updated Successfully ID: {data.id}
              </h1>
              {/* ID: {data.id}
